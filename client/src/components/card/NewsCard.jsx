...
const NewsCard = ({ article }) => {
    return (
        <Card className='theme-shadow border-3 border-dark rounded-0'>
            <Card.Img style={{ height: '200px', objectFit: 'cover' }} variant="top" src={article?.urlToImage || "https://images.unsplash.com/photo-1609743522653-52354461eb27?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"} />
            <Card.Body>
